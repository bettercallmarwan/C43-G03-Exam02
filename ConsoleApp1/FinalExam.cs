...
namespace ConsoleApp1
{
    ...
    {
        public FinalExam(int duration, int numberOfQuestions, List<Question> questions) : base(duration, numberOfQuestions, questions)
        {
        ...
        public override void showExam()
        {
            ...
            for (int i = 0; i < this.questions.Count; i++)
            {
                ...
                } while (!answerFlag || (entered_answer_int < 1 || entered_answer_int > questions[i].Answers.Count));
